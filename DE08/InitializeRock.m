function [ObstaclesPlot]=InitializeRock(v_ImageS1,v_AlphaS1,v_ImageS2,v_AlphaS2,v_ImageS3,v_AlphaS3,v_ImageS4,v_AlphaS4,v_ImageS5,v_AlphaS5,v_ImageS6,v_AlphaS6)
global Obstacles;
global ObstaclesNum;
global EnvironmentWidth;
Width=40;

% Obstacles(:,1) = EnvironmentWidth*(2*rand([ObstaclesNum,1]))/2 - 200;
% Obstacles(:,2) = EnvironmentWidth*(2*rand([ObstaclesNum,1]))/2 - 200;
disp(ObstaclesNum);
...
%%stone 1
    ...
    ObstaclesPlot= image(Obstacles(1,1)- 40, Obstacles(1,2) - 40, img_i);
...
%%stone 2
    ...
    ObstaclesPlot= image(Obstacles(2,1)-40, Obstacles(2,2)-40, img_i);
    ObstaclesPlot.AlphaData = alpha_i;   
%%stone 3
    angle = 0;	% imrotate rotates ccw     
...
%%stone 4
    ...
    ObstaclesPlot= image(Obstacles(4,1)-37.5, Obstacles(4,2)-37.5, img_i);
    ObstaclesPlot.AlphaData = alpha_i;  
%%stone 5
    angle = 0;	% imrotate rotates ccw     
...
%%stone 6
    ...
    ObstaclesPlot= image(Obstacles(6,1)-40, Obstacles(6,2)-40, img_i);
    ObstaclesPlot.AlphaData = alpha_i;  
